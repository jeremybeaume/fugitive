...
class TCPFinInjectEvasion(BaseEvasion):
    """
    Inject a FIN but will not be acked
    """
    ...
    def get_description(self):
        return """Inject a Fin packet"""

TCPFinInjectEvasion.evasion_list = [TCPFinInjectEvasion()]
