...
def compute_frag_size(payload_size, pre_size, post_size,
    ...
    # so can not do if the end of the signature is before the minimum evaded area
    ...
    post_fragment_size, post_evade_frag_size = _divide_area(payload_size - 1 - evasion_area_end,
